...
func (s *testParserSuite) TestDDL(c *C) {
	table := []testCase{
		...
		// for function
		// test drop
		{"DROP FUNCTION sf1", true, "DROP FUNCTION `sf1`"},
		{"drop function if exists sf1", true, "DROP FUNCTION IF EXISTS `sf1`"},
		{"DROP PROCEDURE sp1", true, "DROP PROCEDURE `sp1`"},
		{"DROP PROCEDURE if exists sp1", true, "DROP PROCEDURE IF EXISTS `sp1`"},
		// test alter
		{"alter function sf1", true, "ALTER FUNCTION `sf1`"},
		{"alter function sf1 comment 'ttt'", true, "ALTER FUNCTION `sf1` COMMENT 'ttt'"},
		{"alter function sf1 comment 'ttt' LANGUAGE SQL", true, "ALTER FUNCTION `sf1` COMMENT 'ttt' LANGUAGE SQL"},
		{"alter function sf1 comment 'ttt' LANGUAGE SQL contains sql", true, "ALTER FUNCTION `sf1` COMMENT 'ttt' LANGUAGE SQL CONTAINS SQL"},
		...
		// test deterministic
		{"CREATE FUNCTION sf1 (p1 BIGINT) RETURNS BIGINT NOT DETERMINISTIC", true, "CREATE DEFINER = CURRENT_USER FUNCTION `sf1`(`p1` BIGINT) RETURNS BIGINT NOT DETERMINISTIC"},
		{"CREATE FUNCTION sf1 (p1 BIGINT) RETURNS BIGINT DETERMINISTIC", true, "CREATE DEFINER = CURRENT_USER FUNCTION `sf1`(`p1` BIGINT) RETURNS BIGINT DETERMINISTIC"},

		// test definer definer = 'root'
		{"CREATE definer = 'root' FUNCTION sf2 (p1 BIGINT) RETURNS BIGINT NOT DETERMINISTIC", true, "CREATE DEFINER = `root`@`%` FUNCTION `sf2`(`p1` BIGINT) RETURNS BIGINT NOT DETERMINISTIC"},
		{"CREATE FUNCTION sf3 (p1 BIGINT) RETURNS BIGINT NOT DETERMINISTIC", true, "CREATE DEFINER = CURRENT_USER FUNCTION `sf3`(`p1` BIGINT) RETURNS BIGINT NOT DETERMINISTIC"},

		// test characteristic sql type
		{"CREATE FUNCTION sf1 (p1 BIGINT) RETURNS BIGINT NOT DETERMINISTIC CONTAINS SQL", true, "CREATE DEFINER = CURRENT_USER FUNCTION `sf1`(`p1` BIGINT) RETURNS BIGINT NOT DETERMINISTIC CONTAINS SQL"},
		{"CREATE FUNCTION sf1 (p1 BIGINT) RETURNS BIGINT NOT DETERMINISTIC NO SQL", true, "CREATE DEFINER = CURRENT_USER FUNCTION `sf1`(`p1` BIGINT) RETURNS BIGINT NOT DETERMINISTIC NO SQL"},
		{"CREATE FUNCTION sf1 (p1 BIGINT) RETURNS BIGINT NOT DETERMINISTIC READS SQL DATA", true, "CREATE DEFINER = CURRENT_USER FUNCTION `sf1`(`p1` BIGINT) RETURNS BIGINT NOT DETERMINISTIC READS SQL DATA"},
		{"CREATE FUNCTION sf1 (p1 BIGINT) RETURNS BIGINT NOT DETERMINISTIC MODIFIES SQL DATA", true, "CREATE DEFINER = CURRENT_USER FUNCTION `sf1`(`p1` BIGINT) RETURNS BIGINT NOT DETERMINISTIC MODIFIES SQL DATA"},
		// test sql security
		{"CREATE FUNCTION sf1 (p1 BIGINT) RETURNS BIGINT NOT DETERMINISTIC MODIFIES SQL DATA SQL SECURITY DEFINER", true, "CREATE DEFINER = CURRENT_USER FUNCTION `sf1`(`p1` BIGINT) RETURNS BIGINT NOT DETERMINISTIC MODIFIES SQL DATA SQL SECURITY DEFINER"},
		{"CREATE FUNCTION sf1 (p1 BIGINT) RETURNS BIGINT NOT DETERMINISTIC MODIFIES SQL DATA SQL SECURITY INVOKER", true, "CREATE DEFINER = CURRENT_USER FUNCTION `sf1`(`p1` BIGINT) RETURNS BIGINT NOT DETERMINISTIC MODIFIES SQL DATA SQL SECURITY INVOKER"},
